...
.cloud4 {
  ...
  z-index: 200;
  fill: var(--color-1-light);
  -webkit-animation: move 25s linear 10s infinite backwards;
  -moz-animation: move 25s linear 10s infinite backwards;
  -o-animation: move 25s linear 10s infinite backwards;
  animation: move 25s linear 10s infinite backwards;
}
...
.cloud5 {
  ...
  z-index: 200;
  fill: var(--color-1-light);
  -webkit-animation: move 18s linear 8s infinite backwards;
  -moz-animation: move 18s linear 8s infinite backwards;
  -o-animation: move 18s linear 8s infinite backwards;
  animation: move 18s linear 8s infinite backwards;
}
